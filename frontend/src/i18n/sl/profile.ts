...
export const profile: ProfileDict = {
    ...
    "gameStats.gamesOf.two": "{n} partij",
    "gameStats.gamesOf.few": "{n} partij",
    "gameStats.gamesOf.other": "{n} partij",
    "gameStats.lastDays.one": "zadnji {n} dan",
    "gameStats.lastDays.two": "zadnja {n} dneva",
    "gameStats.lastDays.few": "zadnjih {n} dni",
    "gameStats.lastDays.other": "zadnjih {n} dni",
    "gameStats.daysDuration.one": "{n} dan",
    "gameStats.daysDuration.two": "{n} dneva",
    "gameStats.daysDuration.few": "{n} dni",
    "gameStats.daysDuration.other": "{n} dni",
