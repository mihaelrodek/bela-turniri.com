...
export const tournament: TournamentDict = {
    ...
    "rule.end.prolaz": "Prehod",
    "rule.end.dosta": "Dosta",
    "rule.direction.right": "Desno",
    ...
    "edit.gameEndRule": "Igra se na",
    "edit.dealDirection": "Smer deljenja",
    "edit.declarations": "Napovedi",
    "edit.allowBela": "Bela je dovoljena",
