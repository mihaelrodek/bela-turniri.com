...
export const forms: FormsDict = {
    ...
    "auth.validation.emailRequired": "Vpiši e-poštni naslov.",
    "auth.validation.passwordRequired": "Vpiši geslo.",
    "auth.validation.nameInvalid": "Ime lahko vsebuje samo črke, presledek, vezaj, opuščaj in piko (do 50 znakov).",
    "auth.validation.passwordTooLong": "Geslo je predolgo (največ 128 znakov).",
    "auth.error.popupBlocked": "Brskalnik je blokiral pojavno okno. Dovoli pojavna okna in poskusi znova.",
    "auth.error.accountExistsDifferentCredential": "Račun s tem e-poštnim naslovom že obstaja, a z drugim načinom prijave. Prijavi se na način, ki si ga uporabil prvič.",
    "auth.error.providerNotEnabled": "Ta način prijave trenutno ni na voljo.",
    "auth.error.network": "Ni povezave z internetom. Preveri omrežje in poskusi znova.",
    "auth.consent.checkboxPrefix": "Star sem najmanj 16 let in sprejemam",
    "auth.consent.noticePrefix": "Z nadaljevanjem potrjuješ, da si star 16+ let in sprejemaš",
    "auth.consent.terms": "Pogoje uporabe",
    "auth.consent.and": "in",
    "auth.consent.privacy": "Politiko zasebnosti",
    "auth.consent.required": "Potrditi moraš, da si star najmanj 16 let in sprejemaš pogoje.",

    // --- LoginPage.tsx -------------------------------------------------------
    "login.heading": "Prijava",
    "login.subtitle": "Prijavi se in nadaljuj, kjer si ostal.",
    "login.googleButton": "Nadaljuj z Googlom",
    "login.appleButton": "Prijavi se z Applom",
    ...
    "register.subtitle": "Ustvari račun v nekaj minutah.",
    "register.googleButton": "Registriraj se z Googlom",
    "register.appleButton": "Registriraj se z Applom",
    "register.nameLabel": "Ime",
    "register.nameOptional": "(neobvezno)",
    "register.namePlaceholder": "npr. Marko",
    "register.passwordHelper": "Vsaj 6 znakov. Priporočamo 8+ zaradi varnosti.",
