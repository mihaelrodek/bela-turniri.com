...
export const common: CommonDict = {
    ...
    "nav.igraj": "Play",
    "nav.new": "New",
    "nav.liveRooms.one": "{n} room",
    "nav.liveRooms.two": "{n} rooms",
    "nav.liveRooms.few": "{n} rooms",
    "nav.liveRooms.other": "{n} rooms",
    "nav.liveRoomsAria.one": "{n} active room",
    "nav.liveRoomsAria.two": "{n} active rooms",
    "nav.liveRoomsAria.few": "{n} active rooms",
    "nav.liveRoomsAria.other": "{n} active rooms",
    "nav.blok": "Score pad",
    "nav.logout": "Sign out",
