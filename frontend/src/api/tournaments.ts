...
export async function createTournament(
    ...
    const body: CreateTournamentPayload = {
        ...
        targetScore: payload.targetScore ?? 1001,
        gameEndRule: payload.gameEndRule ?? "prolaz",
        dealDirection: payload.dealDirection ?? "right",
        declarationsEnabled: payload.declarationsEnabled ?? true,
        allowBela: payload.allowBela ?? true,
