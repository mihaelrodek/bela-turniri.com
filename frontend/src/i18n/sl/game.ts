...
export const game: GameDict = {
    ...
    "guest.back": "Nazaj",
    "guest.heroTitle": "Zaigraj belo takoj",
    "guest.heroSubtitle": "Brez računa in brez namestitve. Izberi ime in lik ter sedi za mizo.",
    "guest.playNow": "Igraj takoj kot gost",
    "guest.youBadge": "Ti",
    "guest.perk.noAccount": "Brez registracije",
    "guest.perk.free": "Brezplačno",
    "guest.perk.bots": "Z ljudmi ali boti",
    "guest.or": "ali",
    ...
    "karma.gamesOf.two": "{n} partij",
    "karma.gamesOf.few": "{n} partij",
    "karma.gamesOf.other": "{n} partij",
    "karma.lastDays.one": "zadnji {n} dan",
    "karma.lastDays.two": "zadnja {n} dneva",
    "karma.lastDays.few": "zadnjih {n} dni",
    "karma.lastDays.other": "zadnjih {n} dni",
    "karma.daysDuration.one": "{n} dan",
    "karma.daysDuration.two": "{n} dneva",
    "karma.daysDuration.few": "{n} dni",
    "karma.daysDuration.other": "{n} dni",
    ...
    "active.leaveNow": "Zapusti",
    "active.leaveConfirm.title": "Zapustiti partijo?",
    "active.leaveConfirm.body": "Takoj izgubiš mesto za mizo, prevzame ga bot in v to partijo se ne moreš več vrniti. Izgubiš tudi 1 točko karme (razen če so za mizo ostali samo boti).",
    "active.leaveConfirm.confirm": "Zapusti partijo",
