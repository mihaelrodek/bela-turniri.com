...
const SECTIONS: Section[] = [
    ...
    { headingKey: "purpose", bodyKeys: ["body1", "body2", "body3", "body4"] },
    { headingKey: "recipients", bodyKeys: ["body1", "body2", "body3", "body4", "body5", "body6"] },
    { headingKey: "retention", bodyKeys: ["body", "body2"] },
    { headingKey: "accountDeletion", bodyKeys: ["body1", "body2", "body3"] },
