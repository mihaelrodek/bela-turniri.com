...
export const admin: AdminDict = {
    "analytics.title": "Analitika spletne igre",
    "analytics.description": "Zasebna globalna statistika vseh spletnih sob in iger. Podatki se zbirajo od uvedbe te analitike.",
    "analytics.loading": "Nalaganje analitike…",
    "analytics.error": "Analitike ni bilo mogoče naložiti.",
    "analytics.roomsCreated": "Ustvarjene sobe",
    "analytics.gamesStarted": "Začete igre",
    "analytics.completed": "Končane",
    "analytics.abandoned": "Zapuščene",
    "analytics.inProgress": "V teku",
    "analytics.completionRate": "Končano {value}%",
    "analytics.targets": "Kategorije",
    "analytics.targetRow": "{started} začetih · {completed} končanih · {abandoned} zapuščenih",
    "analytics.trumps": "Aduti in uspeh klicanja",
    "analytics.trumpRow": "{calls}-krat · {share}% vseh · {success}% uspeh · {falls} padcev",
    "analytics.positions": "Vrstni red klicanja",
    "analytics.position": "{position}. na vrsti",
    "analytics.positionRow": "{calls} klicev · {success}% uspeh · {falls} padcev",
    "analytics.details": "Dodatni kazalniki",
    "analytics.deals": "Odigrane delitve",
    "analytics.avgDeals": "Povprečje delitev / igra",
    "analytics.avgDuration": "Povprečno trajanje",
    "analytics.minutes": "{value} min",
    "analytics.declarationPoints": "Točke napovedi",
    "analytics.stiglja": "Štiglje",
    "analytics.belot": "Beloti",
    "analytics.autoPlayed": "Samodejne poteze",
    "analytics.tableMix": "Sestava miz",
    "analytics.humans": "Samo igralci",
    "analytics.mixed": "Igralci in boti",
    "analytics.bots": "Samo boti",
    "analytics.visibility": "Vidnost sob",
    "analytics.public": "Javne",
    "analytics.private": "Zasebne",
    /* Kdo je igral — bere se iz zabeleženih končanih partij, ne iz
       analitičnih dogodkov, zato ima svojo zahtevo in svoje nalaganje. */
    "analytics.players": "Kdo je igral",
    "analytics.playersCount.one": "{n} igralec",
    "analytics.playersCount.two": "{n} igralca",
    "analytics.playersCount.few": "{n} igralci",
    "analytics.playersCount.other": "{n} igralcev",
    "analytics.playersLoading": "Nalaganje igralcev…",
    "analytics.playersEmpty": "Zabeleženih končanih partij še ni.",
    "analytics.playersCapped": "Prikazanih prvih {shown} po številu partij.",
    "analytics.playerGames": "{games} partij",
    "analytics.playerRecord": "{wins} zmag · {losses} porazov",
    "analytics.playerLast": "zadnja {date}",
    "analytics.playerAbandons": "{abandons} zapustitev",
    "analytics.playerKarma": "karma {karma}/{max}",
    "analytics.anonymous": "Gostje in boti",
    "analytics.guestSeats": "Mesta gostov: {seats} ({wins} zmag)",
    "analytics.botSeats": "Mesta botov: {seats}",
    "analytics.demoSeats": "Mesta lažnih ljudi (demo): {seats}",
    "analytics.demoGames": "Partije proti lažnim ljudem (demo): {games}",
    "analytics.botOnlyGames": "Partije samo proti botom: {games}",
    "analytics.kindAccount": "Račun",
    "analytics.kindGuest": "Gost",
    "analytics.playerRanked": "od tega rangiranih: {games} ({wins}-{losses})",
    "analytics.guestsNote": "Gostje nimajo računa, zato so združeni po imenu, pod katerim so igrali — dva človeka z istim imenom sta ena vrstica. Mesta gostov zgoraj štejejo sedeže, tudi starejše, za katere ime ni shranjeno.",
    "analytics.rankedNote": "Seznam šteje vse zabeležene partije, tudi tiste proti botom in lažnim ljudem. »Rangirane« so samo tiste, ki gredo v igralčevo uradno razmerje in karmo (vsaka ekipa mora imeti vsaj enega človeka).",
    /* ─── CjenikTab ─────────────────────────────────────────── */
    ...
    /* ─── AdminDashboardTab: „Prijave” (moderacija vsebine) ─────
       Razlogi so oznake vrstice v čakalni vrsti, ne stavki, ki jih izbira
       uporabnik — ti so v rječniku `profile`. Števec spodaj ima dvojino. */
    "reports.heading": "Prijave",
    "reports.description": "Prijave vsebine, ki so jih poslali uporabniki. Vsako zapri z „Zavrni” ali „Rešeno”.",
    "reports.filterOpen": "Odprte",
    "reports.filterResolved": "Rešene",
    "reports.loadFailed": "Prijav ni mogoče naložiti.",
    "reports.empty": "Ni prijav.",
    "reports.targetType.TOURNAMENT": "Turnir",
    "reports.targetType.PAIR": "Par",
    "reports.targetType.PROFILE": "Profil",
    "reports.reason.SPAM": "Spam",
    "reports.reason.OFFENSIVE": "Žaljivo",
    "reports.reason.PERSONAL_DATA": "Osebni podatki",
    "reports.reason.OTHER": "Drugo",
    "reports.resolution.DISMISSED": "Zavrnjeno",
    "reports.resolution.ACTIONED": "Rešeno",
    "reports.reporter": "UID: {uid}",
    "reports.noteShown": "Zaznamek: {note}",
    "reports.notePlaceholder": "Interni zaznamek (ni obvezno)…",
    "reports.dismiss": "Zavrni",
    "reports.action": "Rešeno",
    "reports.toast.resolved": "Prijava je zaprta",
    "reports.toast.failed": "Zapiranje prijave ni uspelo",
    "reports.openCount.one": "{n} odprta prijava",
    "reports.openCount.two": "{n} odprti prijavi",
    "reports.openCount.few": "{n} odprte prijave",
    "reports.openCount.other": "{n} odprtih prijav",
}
