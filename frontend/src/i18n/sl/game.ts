...
export const game: GameDict = {
    ...
    "karma.explain": "Karma kaže, koliko se lahko zaneseš na igralca. Vsi začnejo z {max}/{max}. Zapustitev partije, ki teče, ob vsaj še enem igralcu odvzame 1 točko — ko poteče čas za vrnitev za mizo. Vsaka zapustitev velja {window}, nato pa sama odpade. Z igranjem se nič ne vrne. Karmo vidijo drugi igralci v sobi.",
