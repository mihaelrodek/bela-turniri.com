...
export function usePolling(
    ...
    useEffect(() => {
        ...
        // Immediate first load — but only while the tab is actually visible.
        // A hidden tab (background tab, minimised window) skips this call;
        // the `visibilitychange` listener below fires it the moment the tab
        // is shown, and the interval below only ticks while visible anyway.
